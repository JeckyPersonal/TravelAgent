...
namespace Invoice.Migrations
{
    ...
    [Migration("20251120163732_Established ManyToMany Relation between invoice and payment")]
    partial class EstablishedManyToManyRelationbetweeninvoiceandpayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Invoice.Model.InvoicePayment", b =>
                {
                    b.Property<int>("InvoiceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.Model.VoucherMaster", b =>
                {
                    ...
                    b.Property<string>("BillingWorkType")
                        .IsRequired()
                        .HasMaxLength(25)
                        .HasColumnType("varchar")
                        .HasColumnName("billing_work_type");
            ...
            modelBuilder.Entity("Invoice.Model.InvoicePayment", b =>
                {
                    b.HasOne("Invoice.Model.Invoice", "Invoice")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_INVOICE_INVOICE_PAYMENT");

                    b.HasOne("Invoice.Model.PaymentReceived", "Payment")
                        .WithMany("InvoicePayments")
